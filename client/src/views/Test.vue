<!-- <template>
    <div id="app" class="checkbox-select">
        ...
        <div id="dropdown" class="checkbox-select__dropdown" :class="{ activeSearch: showLoader }">
            <div class="checkbox-select__search-wrapp">
                <input type="text" @focus="showLoader = true" @blur="showLoader = false" placeholder="search filters..."
                    v-model="search">
            </div>
            <div class="checkbox-select__col">
                <div class="checkbox-select__select-all" v-model="selectAll"><label for="selectAll">{{
                    selectAllText
                }}</label>
    ...
    <div class="link">
        <a href="https://codepen.io/microfront/pens/public/" target="_blank"> <span class="fa fa-codepen"></span>my
            other Pens</a>
    </div>
</template>
...
body {
    ...
    padding: 0 15px;
    background: #8f24ed;
    background: -moz-linear-gradient(-45deg, #8f24ed 20%, #8f24ed 20%, #8f24ed 22%, #8f24ed 25%, #107cb3 100%);
    background: -webkit-linear-gradient(-45deg, #8f24ed 20%, #8f24ed 20%, #8f24ed 22%, #8f24ed 25%, #107cb3 100%);
    background: linear-gradient(135deg, #8f24ed 20%, #8f24ed 20%, #8f24ed 22%, #8f24ed 25%, #107cb3 100%);
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#8f24ed", endColorstr="#107cb3", GradientType=1);
    display: flex;
    align-items: center;
